...
# def make_automic_VVMDP():
#     #generate set of all possible allocations for Autonomic Computing
#     l = {(i,j) for i,j in product(range(3), range(3))}
#     l.difference_update({(2,2)})
#
#     _demand_loop = {(i,j) for i,j in product([1,2],[1,2])}
#     _t = { ( ((i,j),(m,n)), (p,q) , ((p,q),(r,s)) ):0.125 for (i,j),(m,n),(p,q),(r,s) in product(l,l,_demand_loop,l)}
#
#
#     autonomic_mdp = VVMdp(
#         _startingstate= ((0,0),(0,0)),
#         _transitions= _t,
#         _rewards=
#
#     )
...
#     U = None
#     Vbar = []
#     for Lambda in zip( np.linspace(0,1.0,20) , np.linspace(1.0,0,20) ):
#         print "doing for Lambda = ",Lambda
#         print
#         gridMdp.set_Lambda( Lambda )
#         U = gridMdp.value_iteration(_Uvec=U,k=100)
#         Vbar.append( sum(U)/len(U) )
#     print "done"
#     exit()
...
# print f.rewards
#
# print f.rev_transitions




# m = make_grid_VVMDP(10)
# uvec = m.value_iteration(0.001, None, 100000, None,False)
#
#
# print 'uvec'
# print uvec
#
# pi = m.best_policy(uvec)
# print 'pi'
# print pi
#
# show_grid_policy(m,pi,10)